...
LISTENERS["low-bat-notification"]="$HOME/.config/hypr/scripts/listeners/low-bat-notification.sh"
# Example for another listener:
# LISTENERS["another-listener"]="$HOME/.config/hypr/scripts/listeners/another-listener.sh"
